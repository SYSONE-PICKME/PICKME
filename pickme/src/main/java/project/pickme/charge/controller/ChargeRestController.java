...
public class ChargeRestController {
	 ...
	 *
	 * @param request 결제 요청 정보를 담고 있는 {@link ChargeRequest} 객체입니다.
	 * @return 결제가 성공적으로 처리된 경우 "결제가 성공적으로 완료되었습니다."라는 메시지를 담은 {@link BaseResponse} 객체를 반환합니다.
	 * @throws IamportResponseException 결제 처리 중 아임포트 API 응답에서 오류가 발생한 경우 발생합니다.
	 * @throws IOException 결제 처리 중 I/O 관련 오류가 발생한 경우 발생합니다.
	 */
