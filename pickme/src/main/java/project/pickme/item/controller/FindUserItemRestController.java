...
public class FindUserItemRestController {
	 ...
	 * @param cursor 아이템 목록 조회 시 페이징 및 필터링을 위한 {@link ItemRequest.Cursor} 객체입니다.
	 * @return 조회된 아이템 목록을 담고 있는 {@link BaseResponse} 객체를 반환합니다.
	 */
	@GetMapping("/list")
	 ...
	 *
	 * @param user 현재 인증된 사용자 정보입니다.
	 * @param pageable 페이지네이션 정보를 담고 있는 {@link Pageable} 객체입니다.
	 * @return 조회된 위시 리스트 아이템 목록을 {@link Page} 형태로 담고 있는 {@link BaseResponse} 객체를 반환합니다.
	 */
	 ...
	 *
	 * @param user 현재 인증된 사용자 정보입니다.
	 * @param cursor 입찰 목록 조회 시 페이징 및 필터링을 위한 {@link ItemRequest.BidCursor} 객체입니다.
	 * @return 조회된 입찰 아이템 목록을 담고 있는 {@link BaseResponse} 객체를 반환합니다.
	 */
	@GetMapping("/bid-list")
